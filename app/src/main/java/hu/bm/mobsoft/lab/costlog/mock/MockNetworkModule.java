...
import hu.bm.mobsoft.lab.costlog.network.NetworkModule;
...
public class MockNetworkModule {
    ...
    @Provides
    @Singleton
    public LoginApi provideAuthApi(Retrofit retrofit) {
        return networkModule.provideALoginApi(retrofit);
    }

    @Provides
    @Singleton
    public ItemApi provideItemApi(Retrofit retrofit) {
        return networkModule.provideAnItemApi(retrofit);
    }
